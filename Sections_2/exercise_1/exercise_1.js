...
// You don't have to do anything else with those variables / constants.

// Important: For the automatic solution checking to work, make sure you use exactly the variable / constant names a, b and sum!
